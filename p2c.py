...
class P2_Capital(Base_Capital):
    def code(self, state, ledger):
        self.internal_ledger = ledger
        attack_rng = 2
        action, direction, option = ("Wait", None, None)
        message = "Hello World"
